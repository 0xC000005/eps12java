...
/**
 * Class that creates each players' hand. Methods will get the best (highest) value of
 ...
 * started with INITIAL_HAND_SIZE, or the number of cards, and cards cannot be removed
 * by the user.
 *
 * @author Mike
 */
